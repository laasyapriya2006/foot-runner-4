...
var runningMan,runningManImg,collidedMan,jumpingMan,bendingMan,invisibleGround;
...
function preload()
{
	runningManImg = loadAnimation("images/runningMan1.png","images/runningMan2.png",
	"images/runningMan3.png","images/runningMan4.png","images/jumpingMan.png");
	collidedMan = loadAnimation("images/runningMan4.png");
	jumpingMan = loadAnimation("images/jumpingMan.png","images/runningMan1");
	bendingMan = loadAnimation("images/bendingMan.png");
...
function setup() {
	...
	runningMan = createSprite(300,300);
	...
	runningMan.addAnimation("bendingMan",bendingMan)
	runningMan.scale = 0.75;
	runningMan.visible = false;
	//runningMan.debug = true;
	runningMan.setCollider("circle",0,0,70);

	playButton = createSprite(300,320);
	...
	invisibleGround = createSprite(300,400,displayWidth,10);
...
function spawnBirds(){
	if(frameCount%250 === 0){
		...
		var bird = createSprite(displayWidth,random(displayHeight-450,displayHeight-550));
...
function start(){
	...
	"- You can jump using the up-arrow\n"+
	"- You can bend down using the down-arrow",30,30);

	text("Click here to play",30,320);
...
function play(){
	...
	runningMan.velocityY = runningMan.velocityY+0.8;

	if(keyWentDown("DOWN_ARROW"))
	{
		runningMan.velocityY = 20;
		runningMan.changeAnimation("bendingMan",bendingMan);
	}
